...
Este repositorio contiene el código fuente y los experimentos para el Trabajo de Fin de Grado: **"Detección de estrés multimodal
...
- **`figuras/`**: Gráficas, matrices de confusión y curvas de rendimiento generadas adjuntadas en la memoria del proyecto.
